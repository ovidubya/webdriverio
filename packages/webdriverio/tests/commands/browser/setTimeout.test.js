...
describe('setTimeout', () => {
    ...
    it('should set timeout', async () => {
        ...
        expect(got.mock.calls[1][1].uri.pathname).toBe('/wd/hub/session/foobar-123/timeouts')
        ...
        expect(got.mock.calls[2][1].uri.pathname).toBe('/wd/hub/session/foobar-123/timeouts')
        ...
        expect(got.mock.calls[3][1].uri.pathname).toBe('/wd/hub/session/foobar-123/timeouts')
        ...
        expect(got.mock.calls[4][1].uri.pathname).toBe('/wd/hub/session/foobar-123/timeouts')
        ...
        expect(got.mock.calls[5][1].uri.pathname).toBe('/wd/hub/session/foobar-123/timeouts')
    ...
    it('should set timeout (no w3c)', async () => {
        ...
        expect(got.mock.calls[6][1].uri.pathname).toBe('/wd/hub/session/foobar-123/timeouts')
