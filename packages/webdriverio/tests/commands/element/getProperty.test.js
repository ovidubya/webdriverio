...
describe('getProperty test', () => {
    it('should allow to get the property of an element', async () => {
        ...
        expect(got.mock.calls[2][1].uri.pathname).toBe('/wd/hub/session/foobar-123/element/some-elem-123/property/tagName')
    ...
    it('should allow to get the property of an element jsonwp style', async () => {
        ...
        expect(got.mock.calls[2][1].uri.pathname).toBe('/wd/hub/session/foobar-123/execute')
        expect(property).toBe('BODY')
    })
