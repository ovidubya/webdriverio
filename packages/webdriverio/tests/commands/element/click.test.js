...
describe('click test', () => {
    it('should allow to left click on an element without passing a button type', async () => {
        ...
        expect(got.mock.calls[2][1].uri.pathname).toBe('/wd/hub/session/foobar-123/element/some-elem-123/click')
    })
    ...
    it('should allow to left click on an element by passing a button type', async () => {
        ...
        expect(got.mock.calls[2][1].uri.pathname).toBe('/wd/hub/session/foobar-123/actions')
    ...
    it('should allow to left click on an element (no w3c)', async () => {
        ...
        expect(got.mock.calls[3][1].uri.pathname).toBe('/wd/hub/session/foobar-123/moveto')
        expect(got.mock.calls[3][1].json).toStrictEqual({ element: 'some-elem-123', xoffset: 25, yoffset: 15 })
        expect(got.mock.calls[4][1].uri.pathname).toBe('/wd/hub/session/foobar-123/click')
